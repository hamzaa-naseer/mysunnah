...
// Stripe Payment Api
export const CREATE_STRIPE_PAYMENT_INTENT = "create_stripe_payment_intent";
export const CONFIRM_STRIPE_PAYMENT = "confirm_stripe_payment";
export const GET_STRIPE_COIN_PACKAGES = "get_stripe_coin_packages";
export const GET_STRIPE_TRANSACTION_HISTORY = "get_stripe_transaction_history";
export const GET_STRIPE_SETTINGS = "get_stripe_settings";
...
// 57. create stripe payment intent
export const createStripePaymentIntentApi = (amount, coins) => {
  return {
    url: `${CREATE_STRIPE_PAYMENT_INTENT}`,
    method: 'POST',
    data: {
      amount: amount,
      coins: coins,
...
// 58. confirm stripe payment
export const confirmStripePaymentApi = (payment_intent_id) => {
  return {
...
// 59. get stripe coin packages
export const getStripeCoinPackagesApi = () => {
  return {
    url: `${GET_STRIPE_COIN_PACKAGES}`,
    method: 'POST',
    data: {},
    authorizationHeader: true,
  }
...
// 60. get stripe transaction history
export const getStripeTransactionHistoryApi = () => {
  return {
    url: `${GET_STRIPE_TRANSACTION_HISTORY}`,
    method: 'POST',
    data: {},
    authorizationHeader: true,
  }
...
// 61. get stripe settings (fallback to system configurations if dedicated endpoint doesn't exist)
export const getStripeSettingsApi = () => {
  return {
